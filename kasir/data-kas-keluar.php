      ...
      <div class="row">
        ...
        <div class="col-md-4">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form id="formkaskeluar" action="#" class="formkaskeluar" method="POST">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="hidden" class="form-control" id="idkaskeluar" placeholder="ID Kas Masuk" name="idkaskeluar" value="<?php echo $noidkaskeluar1 ?>" readonly required >
        ...
        <div class="col-md-8">
          ...
          <div class="box box-info">
            ...
            <form action="#" class="form-horizontal" method="POST">
              <div class="box-body">
                <div class="tampildatakaskeluar">
                    <?php
                        include "data-kas-keluar-tmp.php";
                    ?>
            ...
            <a href="././App-Laporan-Pengeluaran" title="Laporan Pengeluaran">
    <button type="button">
    <h4 class="modal-title"><i class="glyph-icon icon-eye"> <strong>Lihat Laporan Pengeluaran</strong></i></h4>
    </button></a>
          </div>
          <!-- /.box -->
        </div>
    ...
    $("#posting").click(function(){
        ...
        if(keterangan == ""){
            ...
            bootbox.confirm("Anda yakin untuk posting data ?", function(result){
                if(result==true){
                var data = $('.formkaskeluar').serialize();
                $.ajax({
                    type: 'POST',
                    url: "posting-kas-keluar.php",
                    data: data,
                    success: function() {
                        ...
                        setTimeout(function(){
                            $('.tampildatakaskeluar').load("data-kas-keluar-tmp.php");
