          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
                ...
                <div class="box-body">
                    <form action="App-Cetak-Laporan-Keuangan-Pengeluaran" target="_blank" method="POST" name="formpembelian">
                    <div class="row">
                        <!-- /.col-lg-6 -->
                        <div class="col-lg-3">
                  ...
                  <div class="laporanpembelian">
                        <?php
                            include "laporan-keuangan-kas-keluar.php";
                        ?>
                  </div>
                <br>
...
$(document).ready(function(){
    $('#tglakhir').on('change', function() {
      ...
      var b=document.formpembelian.tglakhir.value;
        $.ajax({
            url: "laporan-keuangan-kas-keluar.php",
            type: "POST",
            data : {tgl1: a, tgl2: b,},
