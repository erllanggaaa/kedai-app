        ...
        <div class="col-md-12">
          <div class="panel">
            <div class="panel-body">
              <h3 class="title-hero"><strong>Grafik Pemasukkan</strong></h3>
            </div>
            <div class="box-body">
                <?php
                    include "grafik-kas-masuk.php";
                ?>
            </div>
          </div>
          <div class="panel">
            <div class="panel-body">
              <h3 class="title-hero"><strong>Grafik Pengeluaran</strong></h3>
            </div>
            <div class="box-body">
                <?php
                    include "grafik-kas-keluar.php";
                ?>
            </div>
          </div>
        </div>
