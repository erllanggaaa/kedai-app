    ...
    <div class="example-box-wrapper">
          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
                ...
                <div class="box-body">
                    <form action="App-Cetak-Laporan-Rugi-Laba" target="_blank"  method="POST" name="formpembelian">
                    <div class="row">
                        <!-- /.col-lg-6 -->
                        <div class="col-lg-3">
        ...
        <div class="col-md-10">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
              <div class="box-body">
                <div class="tampillabarugi">
                    <?php
                        include "laporan-rugi-laba.php";
                    ?>
...
$(document).ready(function(){
    $('#tglakhir').on('change', function() {
      ...
      var b=document.formpembelian.tglakhir.value;
        $.ajax({
            url: "laporan-rugi-laba.php",
            type: "POST",
            data : {tgl1: a, tgl2: b,},
            success: function (ajaxData){
                $(".tampillabarugi").html(ajaxData);
            }
        });
    });
}); 
