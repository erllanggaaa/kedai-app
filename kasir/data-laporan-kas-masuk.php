...
<div class="panel-body">
    <div class="example-box-wrapper">
          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
                ...
                <div class="box-body">
                    <form action="App-Cetak-Laporan-Keuangan-Pemasukkan" target="_blank" method="POST" name="formpembelian">
                    <div class="row">
                        <!-- /.col-lg-6 -->
                        <div class="col-lg-3">
                  ...
                  <br>
                  <div class="laporanpembelian">
                        <?php
                            include "laporan-keuangan-kas-masuk.php";
                        ?>
                  </div>
                <br>
        ...
        <div id="ModalDetailPembelian" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"></div>
...
$(document).ready(function(){
    $('#tglakhir').on('change', function() {
      var a=document.formpembelian.tglawal.value;
      var b=document.formpembelian.tglakhir.value;
        $.ajax({
            url: "laporan-keuangan-kas-masuk.php",
            type: "POST",
            data : {tgl1: a, tgl2: b,},
            success: function (ajaxData){
                $(".laporanpembelian").html(ajaxData);
            }
        });
    });
}); 
